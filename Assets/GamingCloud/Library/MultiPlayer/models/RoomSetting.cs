...
namespace gamingCloud.Network
{
    ...
    public class RoomSetting
    {
        ...
        public string MatchMakingQuery = null;
        ...
        public RoomSetting(string MatchMakingQuery)
        {
            this.MatchMakingQuery = MatchMakingQuery;
        }
        ...
        public RoomSetting(string name, bool isPrivate, int maxPlayersInRoom, string MatchMakingQuery)
        {
            this.name = name;
            this.isPrivate = isPrivate;
            this.maxPlayers = maxPlayersInRoom;
