...
public class GameManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            gCManager.SendEvent("detectWinner", "ali", SendPacketMode.nspMode);
    ...
    public void CapturePieceAt(Vector2Int gridPoint)
    {
        ...
        {
            if (gCManager.isMasterPlayer == true)
            {
                gCManager.SendEvent("detectWinner", SendPacketMode.nspMode);
                Debug.Log(currentPlayer.name + " wins!");
